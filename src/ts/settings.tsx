...
class Setting extends ConfigurableComponent<
    ...
    renderInput() {
        ...
        if(spec.type === "text") {
            return <input
                ...
                onBlur={(e) => this.update(e.target.value, true)}>
            </input>;
        }
    ...
    render() {
        ...
        return <li className={"setting" + (this.props.spec.danger ? " danger" : "")}>
...
class LangSelector extends React.Component<
    ...
    render() {
        return <li className={this.props.selected ? "selected" : ""} onClick={this.props.onSelected}>
